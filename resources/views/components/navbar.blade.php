...
<nav class="navbar  navbar-expand-lg p-3 fixed-top navBar">
    ...
    <ul class="navbar-nav">
        <li class="nav-item g-5 px-3">
            <a class="nav-link d-flex align-items-center justify-content-center gap-2 " aria-current="page" href="{{ route('home') }}"><i class="bi bi-house-door"></i>Home</a>
        </li>
        <li class="nav-item g-5 px-3">
            <a class="nav-link d-flex align-items-center justify-content-center gap-2 " aria-current="page" href="{{ route('product.index') }}"><i class="bi bi-list-columns"></i>I nostri
                prodotti</a>
            </li>
    ...
    <ul class="navbar-nav">
        ...
        <li class="nav-item g-5 px-3">
            ...
            <li class="nav-item g-5 px-3" aria-current="page">
                <a class="nav-link d-flex align-items-center justify-content-center gap-2 " href="{{ route('product.create') }}"><i class="bi bi-plus-circle"></i>Aggiungi prodotto</a>
            </li>
