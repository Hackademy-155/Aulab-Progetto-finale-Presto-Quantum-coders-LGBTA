...
<nav class="navbar navbar-expand-lg p-3 fixed-top navBar">
    ...
    <ul class="navbar-nav w-100">
        ...
        <li class="nav-item g-5 px-3">
            <a class="nav-link d-flex align-items-center justify-content-center gap-2 " aria-current="page"
            href="{{ route('product.index') }}"><i class="bi bi-list-columns"></i>{{__('ui.I nostri prodotti')}}</a>
        </li>
...
<ul class="navbar-nav">
    ...
    <ul class="dropdown-menu dropdown-custom">
        <li class=" text-center p-0">
            ...
            <li class=" text-center p-0">
                <button class="btn"><a class="btn dropdown-btn"
                    href="{{ route('register') }}">{{__('ui.Registrati')}}</a></button>
                </li>
            </ul>
        </li>
    </ul>
...
<nav class="navbar navbar-expand-lg py-3 fixed-top navBar">
    ...
    <ul class="navbar-nav w-100">
        ...
        <li class="nav-item g-5 px-3" aria-current="page">
            ...
            href="{{ route('product.create') }}"><i class="bi bi-plus-circle"></i>{{__('ui.Aggiungi prodotto')}}</a>
        </li>
    ...
    <li class="nav-item">
        <a class=" nav-link d-flex align-items-center justify-content-center gap-2 " data-bs-toggle="offcanvas" href="#offcanvasTop" role="button"
...
<div class="offcanvas  offcanvas-top OffCanvas-custom p-0 m-0 custom-vertical rounded-4 " tabindex="-1" id="offcanvasTop" aria-labelledby="offcanvasTopLabel">
    <div class="d-flex justify-content-around align-items-center text-center ">

        <button type="button" class="btn-close ms-auto mx-4 mt-4" data-bs-dismiss="offcanvas" aria-label="Close"></button>
    </div>
            ...
            <div class="row ">
                <div class="col-12 ">
                    <form class="d-flex ms-auto " role="search" action="{{ route('products.search') }}" method="GET">
                        <input class="form-control me-2" name="query" type="search" placeholder="{{__('ui.Cerca il tuo prodotto...')}}"
                        aria-label="Search">
                        <button class="button-offcanvas text-light btn" type="submit" id="basic-addon2">{{__('ui.Cerca')}}</button>
                    </form>
                </div>
            </div>
